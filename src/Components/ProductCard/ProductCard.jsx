      ...
      < div className="flex overflow-hidden md:transform md:origin-center md:transition-transform duration-400  md:hover:scale-[102%] w-[273px] h-[137x] bg-white m-auto  rounded-[20px] drop-shadow-lg border-black ">
        <div className="flex p-2">
          ...
          <div className='ml-4'>
            ...
            {count === 0 && (
              <button onClick={increment} className='text-[#57d742] items-center justify-center w-[74px] h-[26px] border-[1.5px] mt-3 ml-1 shadow-3xl border-[#b0b0b0] rounded-[10px]'>
                ADD
              </button>
            )}
            {count !== 0 && (
              <div className='flex h-[30px] w-[100px] mt-3'>
                ...
                <button className='bg-zoop items-center justify-center w-[25px] h-[26px] font-extrabold rounded-r-[10px] flex ' onClick={increment}>
                  +
                </button>
              </div>
            )}
